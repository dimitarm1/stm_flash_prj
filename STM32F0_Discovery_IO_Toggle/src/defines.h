...
#define START_COUNTER_TIME  1000000
#define ENTER_SERVICE_DELAY 2000000
#define SERVICE_NEXT_DELAY  400000
#define EXIT_SERVICE_TIME   1200000
#define START_DELAY         200000
